class General {
  factory General() => _getInstance();

  static General get instance => _getInstance();
  static General _instance; // Singleton object

  static General _getInstance() {
    if (_instance == null) {
      _instance = General._internal();
    }
    return _instance;
  }
